		...
		for (Body b : _bodies) {
			 ...
			 if(_showVectors) {
				 ...
				 drawLineWithArrow(gr,
						 ...
						 _centerX + (int) Math.round((_centerX + (int) Math.round(x/_scale)+b.getForce().direction().getX())), // no s� c�mo va el escale. pero hay que poner centro+posCuerpoX+directionX*constante
